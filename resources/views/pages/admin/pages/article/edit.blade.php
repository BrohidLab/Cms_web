...
@section('content')
    <div class="p-8 bg-gray-50 min-h-screen">
        ...
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui dan kelola artikel</p>
        </div>
        ...
        <form action="{{ route('article.update', $article->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <input type="text" id="slug" value="{{ old('slug', $article->slug) }}"
            ...
            <div>
                ...
                <input type="text" name="content_label"
                    value="{{ old('content_label', $article->labels->pluck('name')->implode(', ')) }}"
            ...
            <div>
                ...
                <div id="uploadBox"
                    ...
                    <div id="uploadContent" class="{{ $article->thumbnail ? 'hidden' : '' }} space-y-3">
                    ...
                    @if ($article->thumbnail)
                        <img id="preview" src="{{ asset('storage/' . $article->thumbnail) }}"
                            class="mx-auto max-h-60 rounded-xl shadow-md">
                    @else
            ...
            <div>
                ...
                <textarea name="content" id="editor" rows="10"
                    class="w-full border-gray-300 rounded-xl px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none transition">{{ old('content', $article->content) }}</textarea>
                @error('content')
                    <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                @enderror
            </div>
