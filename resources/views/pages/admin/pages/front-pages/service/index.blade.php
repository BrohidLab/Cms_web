    ...
    <div class="p-6 max-w-3xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">
                Update banner for service page
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm">
            ...
            <form action="{{ route('front_page.service.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="sub_title" rows="4"
                            class="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none">{{ $service->sub_title ?? '' }}</textarea>
                    </div>
