...
@section('content')
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow border border-gray-100 p-8 space-y-10">
            ...
            <div>
                <h2 class="text-lg font-semibold mb-6 text-gray-800">Product Price</h2>
                <form action="{{ route('product.store_price_type') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                            ...
                                            @forelse ($prices as $type)
                                                <tr id="row-{{ $type->id }}" class="hover:bg-gray-50 transition">
                                                    ...
                                                    <td class="px-6 py-4 text-center">
                                                        <button type="button"
                                                            data-url="{{ route('product.destroy_price', $type->id) }}"
            ...
            <div class="flex justify-end mt-6 gap-3">
                <a href="{{ route('product.product.create_product_image', $product->id) }}"
