...
<x-website.banner
    ...
    description="Temukan aksesoris dan sparepart mobil Suzuki dengan kualitas terbaik untuk menjaga performa kendaraan Anda."
...
Tim teknisi kami akan memberikan rekomendasi sparepart terbaik agar performa mobil tetap optimal.
</p>

<div class="space-y-4 text-sm">

<div class="flex items-start gap-3">
<div class="w-6 h-6 flex items-center justify-center bg-blue-100 text-blue-600 rounded-full text-xs">✓</div>
