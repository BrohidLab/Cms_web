...
<x-website.banner
    ...
    description="Temukan berbagai tips, berita, dan insight terbaru seputar otomotif dan kendaraan."
...
<article class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition duration-300">
...
<h3 class="text-lg font-semibold text-gray-800 mb-3 leading-snug group-hover:text-blue-600 transition">
