...
<x-website.banner
     ...
     description="Nikmati layanan service terbaik untuk kendaraan Anda"
...
<div class="max-w-6xl mx-auto px-4">
    ...
    <div class="flex justify-center mb-10 border-b">
        <button class="tab-btn px-6 py-3 text-sm font-medium border-b-2 border-blue-600 text-blue-600" data-tab="jadwal">
            Jadwal Service
        </button>
